...
def test_monte_carlo_prob_over_high_mean():
    # player averaging 30 points against 15.5 line — over probability should be high
...
def test_monte_carlo_prob_under_low_mean():
    # player averaging 5 points against 15.5 line — over probability should be low
...
def test_monte_carlo_zero_sigma_above_line():
    # all same values above line — should return 1.0
...
def test_monte_carlo_zero_sigma_below_line():
    # all same values below line — should return 0.0
...
def test_get_true_prob_all_above():
    # all games above line — weighted prob should be 1.0
...
def test_get_true_prob_all_below():
    # all games below line — weighted prob should be 0.0
